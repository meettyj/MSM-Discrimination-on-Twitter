...
# remove NA value in alcohf1
merged_survey_discrimination_data$alcohf1
merged_survey_discrimination_data <- merged_survey_discrimination_data[which(merged_survey_discrimination_data$alcohf1 !="NA"), ]
merged_survey_discrimination_data$alcohf1
...
# ---- Logistic Regression ----
# Drug use
glm_LR_alcohf1 <- glm(alcohf1 ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium, family="binomial",data=merged_survey_discrimination_data)
summary(glm_LR_alcohf1)

# discrimination variables
glm_LR_alcohf1_AWM_Rac_grid <- glm(alcohf1 ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Rac_grid, family="binomial",data=merged_survey_discrimination_data)
summary(glm_LR_alcohf1_AWM_Rac_grid)

glm_LR_alcohf1_AWM_SSSOM_Hom <- glm(alcohf1 ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_SSSOM_Hom, family="binomial",data=merged_survey_discrimination_data)
summary(glm_LR_alcohf1_AWM_SSSOM_Hom)

glm_LR_alcohf1_AWM_SSSOM_Rac <- glm(alcohf1 ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_SSSOM_Rac, family="binomial",data=merged_survey_discrimination_data)
summary(glm_LR_alcohf1_AWM_SSSOM_Rac)

glm_LR_alcohf1_AWM_Zip_Hom <- glm(alcohf1 ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Zip_Hom, family="binomial",data=merged_survey_discrimination_data)
summary(glm_LR_alcohf1_AWM_Zip_Hom)

glm_LR_alcohf1_AWM_Zip_Rac <- glm(alcohf1 ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Zip_Rac, family="binomial",data=merged_survey_discrimination_data)
summary(glm_LR_alcohf1_AWM_Zip_Rac)
