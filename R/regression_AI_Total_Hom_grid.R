...
zeroinfl_ZIP_AI_Total_AWM_Hom_grid <- zeroinfl(AI_Total ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Hom_grid, dist = "poisson", data=merged_survey_discrimination_data)
summary(zeroinfl_ZIP_AI_Total_AWM_Hom_grid)
