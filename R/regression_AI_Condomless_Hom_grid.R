...
zeroinfl_ZIP_AI_Condomless <- zeroinfl(AI_Condomless ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium, dist = "poisson", data=merged_survey_discrimination_data)
summary(zeroinfl_ZIP_AI_Condomless)

# discrimination variables
zeroinfl_ZIP_AI_Condomless_AWM_Rac_grid <- zeroinfl(AI_Condomless ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Rac_grid, dist = "poisson", data=merged_survey_discrimination_data)
summary(zeroinfl_ZIP_AI_Condomless_AWM_Rac_grid)

zeroinfl_ZIP_AI_Condomless_AWM_SSSOM_Hom <- zeroinfl(AI_Condomless ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_SSSOM_Hom, dist = "poisson", data=merged_survey_discrimination_data)
summary(zeroinfl_ZIP_AI_Condomless_AWM_SSSOM_Hom)

zeroinfl_ZIP_AI_Condomless_AWM_SSSOM_Rac <- zeroinfl(AI_Condomless ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_SSSOM_Rac, dist = "poisson", data=merged_survey_discrimination_data)
summary(zeroinfl_ZIP_AI_Condomless_AWM_SSSOM_Rac)

zeroinfl_ZIP_AI_Condomless_AWM_Zip_Hom <- zeroinfl(AI_Condomless ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Zip_Hom, dist = "poisson", data=merged_survey_discrimination_data)
summary(zeroinfl_ZIP_AI_Condomless_AWM_Zip_Hom)

zeroinfl_ZIP_AI_Condomless_AWM_Zip_Rac <- zeroinfl(AI_Condomless ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Zip_Rac, dist = "poisson", data=merged_survey_discrimination_data)
summary(zeroinfl_ZIP_AI_Condomless_AWM_Zip_Rac)

# added after: AWM_Hom_grid
zeroinfl_ZIP_AI_Condomless_AWM_Hom_grid <- zeroinfl(AI_Condomless ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Hom_grid, dist = "poisson", data=merged_survey_discrimination_data)
summary(zeroinfl_ZIP_AI_Condomless_AWM_Hom_grid)
