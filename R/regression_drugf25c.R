...
# remove NA value in drugf25c
merged_survey_discrimination_data$drugf25c
merged_survey_discrimination_data <- merged_survey_discrimination_data[which(merged_survey_discrimination_data$drugf25c !="NA"), ]
merged_survey_discrimination_data$drugf25c
...
# ---- Poisson Regression ----
glm_poisson_drugf25c <- glm(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium, family="poisson",data=merged_survey_discrimination_data)
summary(glm_poisson_drugf25c)

# discrimination variables
glm_poisson_drugf25c_AWM_Rac_grid <- glm(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Rac_grid, family="poisson",data=merged_survey_discrimination_data)
summary(glm_poisson_drugf25c_AWM_Rac_grid)

glm_poisson_drugf25c_AWM_SSSOM_Hom <- glm(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_SSSOM_Hom, family="poisson",data=merged_survey_discrimination_data)
summary(glm_poisson_drugf25c_AWM_SSSOM_Hom)

glm_poisson_drugf25c_AWM_SSSOM_Rac <- glm(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_SSSOM_Rac, family="poisson",data=merged_survey_discrimination_data)
summary(glm_poisson_drugf25c_AWM_SSSOM_Rac)

glm_poisson_drugf25c_AWM_Zip_Hom <- glm(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Zip_Hom, family="poisson",data=merged_survey_discrimination_data)
summary(glm_poisson_drugf25c_AWM_Zip_Hom)

glm_poisson_drugf25c_AWM_Zip_Rac <- glm(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Zip_Rac, family="poisson",data=merged_survey_discrimination_data)
summary(glm_poisson_drugf25c_AWM_Zip_Rac)


# ---- Negative Binomial ----
glm_nb_drugf25c <- glm.nb(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium, data=merged_survey_discrimination_data)
summary(glm_nb_drugf25c)

# discrimination variables
glm_nb_drugf25c_AWM_Rac_grid <- glm.nb(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Rac_grid, data=merged_survey_discrimination_data)
summary(glm_nb_drugf25c_AWM_Rac_grid)

glm_nb_drugf25c_AWM_SSSOM_Hom <- glm.nb(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_SSSOM_Hom, data=merged_survey_discrimination_data)
summary(glm_nb_drugf25c_AWM_SSSOM_Hom)

glm_nb_drugf25c_AWM_SSSOM_Rac <- glm.nb(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_SSSOM_Rac, data=merged_survey_discrimination_data)
summary(glm_nb_drugf25c_AWM_SSSOM_Rac)

glm_nb_drugf25c_AWM_Zip_Hom <- glm.nb(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Zip_Hom, data=merged_survey_discrimination_data)
summary(glm_nb_drugf25c_AWM_Zip_Hom)

glm_nb_drugf25c_AWM_Zip_Rac <- glm.nb(drugf25c ~ agef1y+eduf1+race_hispanic+race_black+race_asian+race_mixed_or_other+income_high+income_medium+AWM_Zip_Rac, data=merged_survey_discrimination_data)
summary(glm_nb_drugf25c_AWM_Zip_Rac)
